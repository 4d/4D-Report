...
If ($Lon_formEvent=On Load:K2:1)
	...
	OB SET:C1220($Obj_control; \
		...
		"font-color"; Choose:C955($boo_colorSchemeIsLight; "black"; "white"); \
		"mode"; "additive")
	...
	If ($boo_colorSchemeIsLight)
		...
		$tTxt_values{6}:="blue"
	Else 
		$tTxt_values{1}:="#FF6E6E"
		$tTxt_values{2}:="#76D5FE"
		$tTxt_values{3}:="#FFB55C"
		$tTxt_values{4}:="#FFB55C"
		$tTxt_values{5}:="#76D5FE"
		$tTxt_values{6}:="#76D5FE"
	End if 
