...
If ($Lon_formEvent=On Load:K2:1)
	...
	OB SET ARRAY:C1227($Obj_control;"values";$tTxt_values)
	  ...
	  //icons
	ARRAY TEXT:C222($tTxt_values;0x0000)
	APPEND TO ARRAY:C911($tTxt_values;"#Images/widgets/controls/align_both.png")
	APPEND TO ARRAY:C911($tTxt_values;"#Images/widgets/controls/align_left.png")
	APPEND TO ARRAY:C911($tTxt_values;"#Images/widgets/controls/align_center.png")
	APPEND TO ARRAY:C911($tTxt_values;"#Images/widgets/controls/align_right.png")
