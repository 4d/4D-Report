...
If ($Lon_formEvent=On Load:K2:1)
	...
	APPEND TO ARRAY:C911($tTxt_values; "#Images/widgets/controls/style_bold"+Choose:C955($boo_isColorSchemeLight; ".png"; "_dark.png"))
	APPEND TO ARRAY:C911($tTxt_values; "#Images/widgets/controls/style_italic"+Choose:C955($boo_isColorSchemeLight; ".png"; "_dark.png"))
	APPEND TO ARRAY:C911($tTxt_values; "#Images/widgets/controls/style_underline"+Choose:C955($boo_isColorSchemeLight; ".png"; "_dark.png"))
