		...
		If ($Lon_row#0)
			...
			If (<>Boo_debug)
				...
				If ($Boo_data)
					...
					APPEND MENU ITEM:C411($Mnu_main;":xliff:menu_total_spacing")
					SET MENU ITEM PARAMETER:C1004($Mnu_main;-1;"total_spacing")
		...
		: ($Txt_action="border@")
			...
			Case of 
				...
				: (($Lon_column=0) & ($Lon_row=0))// global cells
					...
					For ($Lon_row;qr grand total:K14906:3;Size of array:C274($_arrColumns))
						If ($Lon_row#0)
