...
If (Size of array:C274($tObj_columns)>0)
	...
	$Txt_formula_1:=db_virtualFieldName (OB Get:C1224($tObj_columns{1};"formula";Is text:K8:3))
	
	If (Size of array:C274($tObj_columns)>1)
		
		$Txt_formula_2:=db_virtualFieldName (OB Get:C1224($tObj_columns{2};"formula";Is text:K8:3))
		
		If (Size of array:C274($tObj_columns)>2)
			
			$Txt_formula_3:=db_virtualFieldName (OB Get:C1224($tObj_columns{3};"formula";Is text:K8:3))
