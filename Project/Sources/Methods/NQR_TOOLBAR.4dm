...
Case of 
	...
	: ($Txt_action="tool.@")  //opens/closes the additional panel
		...
		If ($Boo_visible)
			...
			OBJECT SET ENABLED:C1123(*; "toolbar.@.options"; $Lon_destination#_o_qr 4D View area:K14903:3)
...
/* ACI0103036 : this test is not necessary
If ($Boo_enabled)
				
ARRAY TEXT($tTxt_printers; 0x0000)
PRINTERS LIST($tTxt_printers)
				
$Boo_enabled:=(Size of array($tTxt_printers)>0)
				
End if 
				
//enable preview if any
OBJECT SET ENABLED(*; "toolbar.opened.preview"; $Boo_enabled)
*/
			...
			: ($Lon_destination=qr HTML file:K14903:5)
				...
				//-----------------------------
			: ($Lon_destination=_o_qr 4D View area:K14903:3)
