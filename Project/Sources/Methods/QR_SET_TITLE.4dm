...
If (Length:C16($Txt_title)=0)\
 & (Length:C16($Txt_variable)=0)
	
	$Txt_pattern:="(?mi-s)^\\[([^\\]]*)\\]([^-+*/\\\\%=?&|>,:\"(\\[\\$]{1,31})$"  //[table]field
	
	If (Match regex:C1019($Txt_pattern;$Txt_object;1;$tLon_positions;$tLon_lengths))
		
		$Txt_title:=Substring:C12($Txt_object;$tLon_positions{2};$tLon_lengths{2})
